...
base = base.threePointArc((-470.77487817547114, -47.1084512378617), (-454.53, 18.21)).close()
#孔洞截面
#Hole 0
base = base.moveTo(20,20)
base = base.threePointArc((50.0,20.0),(50,50))
base = base.threePointArc((20.0,50.0),(20,20)).close()
#Hole 1
base = base.moveTo(0,0)
base = base.threePointArc((-50.0,0.0),(-50,-50))
base = base.threePointArc((0.0,-50.0),(0,0)).close()
# 扫掠路径（2个点）
def build_path():
...
# 导出结果
#cq.exporters.export(model, "output_with_hole.step")
cq.exporters.export(model, 'output_with_hole.stl', exportType='STL')  
