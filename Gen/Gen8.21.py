...
# 导出结果
cq.exporters.export(final_model, '/data/aihao/DATA/0822test/result/STL', exportType='STL')
"""
...
def process_json_files(input_folder , output_folder):
    ...
    for i, filename in enumerate(all_files):
        ...
        try:
            ...
            output_path = os.path.join(output_folder, f"{i}.py")
            
            generate_cadquery_script(data, output_path)
...
if __name__ == "__main__":
    ...
    input_folder = "/data/aihao/DATA/0822test/20250822_140910"
    output_folder = "/data/aihao/DATA/0822test/result/CADQuery"
