...
def generate_sketch_elliptical_arc(wp_var, edge_params):
    ...
    center = edge_params.get("center", [0, 0])
    ...
    return f"""
#椭圆弧
{wp_var} = {wp_var}.ellipseArc({major}, {minor}, rotation_angle = {rotation_deg}, angle1 = {start_angle}, angle2 = {end_angle}).translate({center})
"""
...
output_file = "../Gen_CADquery/banjian819_test.py"
